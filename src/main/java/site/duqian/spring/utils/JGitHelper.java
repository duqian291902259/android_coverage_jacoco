...
public class JGitHelper {
    ...
    //定义本地git路径
    public static final String LOCAL_PATH = FileUtils.getJacocoDownloadDir() + Constants.GIT_SOURCE_DIR_NAME + File.separator;
    //.git文件路径
    ...
    public static final String GIT_COMMIT_ID = "12939105ad18b92cf2e4f51d8c6a4edd9a6c8a46";
